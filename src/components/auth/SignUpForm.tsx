...
export function SignUpForm() {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-8 shadow-2xl">
        <div className="text-center mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">{t('createAccount')}</h1>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-400">
            ...
            <Link href="/sign-in" className="text-purple-300 hover:text-purple-200 underline">
              Sign in
            </Link>
          </p>
        </div>
