...
export function ProgressPreview({
  ...
  const handleClick = () => {
    if (isGuestMode && onProgressClick) {
      onProgressClick();
      return;
    }
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="hidden sm:flex flex-col items-start">
              <span className="text-xs font-semibold text-white">
                {stats?.masteredFlashcards || 0} mastered
              </span>
              <div className="w-24 h-1.5 bg-white/20 rounded-full overflow-hidden mt-0.5">
                <div
                  ...
                  style={{ width: `${stats && stats.totalFlashcards > 0 ? (stats.masteredFlashcards / stats.totalFlashcards) * 100 : 0}%` }}
                />
              </div>
            </div>
          </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex-1">
                          <div className="flex justify-between items-center mb-1">
                            ...
                            <span className="text-xs text-gray-400">
                              {stats.experiencePoints}/500 XP
                            </span>
                          </div>
                          <Progress
                            value={(stats.experiencePoints % 500) / 5}
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          <div className="flex justify-between items-center mb-1">
                            ...
                            <span className="text-xs text-gray-400">
                              {stats.totalFlashcards > 0 ? ((stats.masteredFlashcards / stats.totalFlashcards) * 100).toFixed(0) : 0}%
                            </span>
                          </div>
                          <Progress
                            value={stats.totalFlashcards > 0 ? (stats.masteredFlashcards / stats.totalFlashcards) * 100 : 0}
                            className="h-2 bg-white/10"
                      ...
                      <div className="bg-amber-500/10 border border-amber-500/30 rounded p-2 mt-3">
                        <p className="text-xs text-amber-300/80">
                          This is demo progress stored locally. Sign in to save real progress!
                        </p>
                      </div>
                    </div>
                  ) : (
